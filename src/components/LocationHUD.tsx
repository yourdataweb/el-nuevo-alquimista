...
export default function LocationHUD() {
  ...
  return (
    <div className="fixed top-14 left-3 z-20 flex items-center gap-2 bg-[#1a1a1a]/90 backdrop-blur-md rounded-xl px-3 py-2 border border-gray-700 shadow-lg pointer-events-auto max-w-[60vw]">
      {/* Character avatar */}
      ...
      <button
        onClick={flyToPlayer}
        className="ml-1 w-7 h-7 rounded-full bg-black/10 hover:bg-black/20 flex items-center justify-center text-xs shrink-0 transition-colors"

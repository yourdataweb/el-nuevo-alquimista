...
export default function MiniGameModal({
  ...
  return (
    ...
    >
      {/* Main card */}
      <div className="relative w-full max-w-3xl mx-4 max-h-[92vh] flex flex-col bg-[#1a1a1a] border border-gray-700 rounded-2xl shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-3 border-b border-gray-700 bg-[#252525]">
        ...
        <div
          ...
          style={backgroundImage ? {
            backgroundImage: `linear-gradient(rgba(15,23,48,0.75), rgba(15,23,48,0.75)), url(${backgroundImage})`,
